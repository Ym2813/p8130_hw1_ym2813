...
```
The box plot of the data is right skewed as the median is closer to the lower quartile, and it is also an unimodal distribution. 
...
```
The box plot of the depression score of those who had bike crash is right skewed and unimodal. The box plot for those who had car crash has an unimodal distribution 
